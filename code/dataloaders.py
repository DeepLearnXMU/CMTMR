...
def load_data(args, bsz=None):
    ...
    graph_batcher_tr, graph_batcher_val, graph_batcher_test, gd = None, None, None, None


    if MODEL in ["GCN", 'GCN_GAN', 'GCN_GAN_QUERY']:
    ...
    return training_generator, validation_generator, test_generator, graph_batcher_tr, graph_batcher_val, graph_batcher_test, gd