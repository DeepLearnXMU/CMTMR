...
class TripletLoss(object):
  ...
  def __init__(self, device=[0], margin=None):
    self.margin = margin
    self.device = device
...
def global_euc_loss(tri_loss, global_feat, labels, normalize_feature=False):
...
def global_cos_loss(tri_loss, global_feat, labels, normalize_feature=False):
